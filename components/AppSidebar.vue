<template>
    <div class="mb-5 flex flex-col space-y-10">
        ...
        <div class="flex flex-col gap-y-6">
            ...
            <button
                class="text-left font-semibold bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 transition ease-in-out p-5"
                @click="$emit('open-tutorial')">このサイトの使い方を見る
                ＞
            </button>
            ...
            <p>
                <a class="bg-blue-100 dark:bg-gray-600" href="https://ja.wikipedia.org/wiki/K平均法">k-平均法</a>（k=100
