<template>
  ...
  <div
    class="relative py-8 px-3 xl:px-8 max-w-sm mx-auto bg-gray-100 hover:bg-gray-200 rounded-xl space-y-2 xl:py-4 xl:flex xl:items-center xl:space-y-0 xl:space-x-14 transition ease-in-out"
